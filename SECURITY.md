...
If you believe you've found a security vulnerability in NarratorAI Web, please report it privately so we can investigate and fix it before public disclosure.
...
- This repository (`narrator-ai-web`) — application code, BFF routes, configuration, dependency vulnerabilities affecting our deployment
- The deployment surface served from this codebase (the web app itself, its `/api/*` BFF endpoints)

This policy does **not** cover:

- **Upstream NarratorAI-compatible OpenAPI providers** — please report directly to the relevant provider
- **Third-party services** you configure for your deployment — report to the respective vendor
